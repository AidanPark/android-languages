package io.separk.android.locale.test.ui
...
import io.separk.android.locale.Language
import io.voyagersoft.android.locale.test.R

@Composable
fun LocalesScreen(
    modifier: Modifier = Modifier
) {
    val languages: List<Language> = Language.getAllLanguages(LocalContext.current).sorted()
